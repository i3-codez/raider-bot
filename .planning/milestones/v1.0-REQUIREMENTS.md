# Requirements Archive: v1.0 Raider Bot MVP

**Archived:** 2026-04-12
**Status:** SHIPPED

The live requirements file is intentionally reset after milestone archival. Define the next milestone requirements fresh before resuming roadmap planning.
